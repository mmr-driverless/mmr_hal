...
// ECU_BOSCH
  ...
  MMR_CAN_MESSAGE_ID_ECU_EBS_PRESSURES, // this might be removed in the future - there is a pressure gauge, so no sensor will be needed - refer to Emanuele
  ...
  MMR_CAN_MESSAGE_ID_ECU_GEAR_UP = 0x610, // Can shift up from NTRL to first
  MMR_CAN_MESSAGE_ID_ECU_GEAR_DOWN = 0x610, // Cannot shift down to NTRL!
  MMR_CAN_MESSAGE_ID_ECU_GEAR_NTRL = 0x628,
  MMR_CAN_MESSAGE_ID_ECU_LAUNCH_CONTROL = 0x628,
// !ECU_BOSCH
